class SignaturesController < ApplicationController
  ...
  def add_signature
      ...
      @signature.signlabel = params[:signlabel]
      @signature.frommail_id = params[:selectfrom]
      @signature.save
      flash[:notice]="Signature is added"
      redirect_to :back 
  end  
  
  
  def add_frommail
     Frommail.create(:frommail=>params[:addfromemail])
     flash[:notice]="From Mail Is Added"
     redirect_to :back
  end  
